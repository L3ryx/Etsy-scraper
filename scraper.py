...
def fetch_via_scraperapi(target_url, scraper_key):
    ...
    try:
        ...
        return None, "Timeout - la page met trop de temps à charger. Réessayez."
...
def analyze_category(query, scraper_key, max_pages=3, sort="most_relevant", progress_callback=None):
    all_listings = []
    total_results = 0
